...
import org.Housing.KCAgentList.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String displayRegistrationForm(Model model){
        ...
        model.addAttribute("title","Agent Registration Form");
        return "register";
    }
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO, Errors errors, HttpServletRequest request, Model model){
        ...
        if(existingUser !=null){
            errors.rejectValue("username","username.alreadyexists","A user with that username already exits");
            model.addAttribute("title","Register");
            return "register";
        }
    ...
    public String displayLoginForm(Model model){
        model.addAttribute("title","Agent Log In");
